...
import { useRef, useEffect, useCallback, useState, type ReactNode, type CSSProperties, type RefObject } from 'react';
...
interface GlobalSpotlightProps {
  ...
  glowColor?: string;
  /** CSS selector for cards within the grid. Defaults to '.magic-bento-card' */
  cardSelector?: string;
}
...
// ── BentoSection (grid wrapper with spotlight) ─────────
